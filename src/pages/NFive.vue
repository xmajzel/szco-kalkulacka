...
const constantData = reactive({
  ...
  // https://www.podnikajte.sk/dan-z-prijmov/nezdanitelne-casti-zakladu-dane-2025
  nonTaxableBase: 5753.79,
  nonTaxableMaxBase: 25426.27,
  nonTaxableBaseAdjustmentCoefficient: 12110.36,
...
const inputs = reactive({
  sales: 0,
  expenses: 1666.66,
  healthInsuranceAdvances: 107.25,
  socialInsuranceAdvances: 237.02,
});
...
const results = computed(() => {
  ...
  const applicableNonTaxableBase =
    _tAssessmentBase * 12 < constantData.nonTaxableMaxBase
      ? constantData.nonTaxableBase / 12
      : Math.max(constantData.nonTaxableBaseAdjustmentCoefficient - (1 / 4) * (_tAssessmentBase * 12), 0) / 12;
